  ...
  <div class="container">
    ...
    <div class="swiper init-swiper" data-aos="fade-up" data-aos-delay="100">
      ...
      <div class="swiper-wrapper">
        <?php if ($gunun_mansetleri && $gunun_mansetleri->num_rows > 0): ?>
          <?php while ($row = $gunun_mansetleri->fetch_assoc()): ?>
        ...
        <?php else: ?>
          <div class="swiper-slide">
            <div class="row gy-4 event-item">
              <div class="col-12 text-center">
                <h3>Henüz manşet eklenmemiş</h3>
                <p>Admin panelinden “Günün Manşetleri” ekleyebilirsin.</p>
              </div>
            </div>
          </div>
        <?php endif; ?>
